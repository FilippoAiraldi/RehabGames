...
public class GameController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Assert(this.ballRigidBody != null, "Controller ball rigid body expected to be non-null");
    ...
    {
        this.ball.transform.position = new Vector2(0, -7.5f);
        ...
        this.ballRigidBody.velocity = new Vector2(Mathf.Cos(angle), Mathf.Sin(angle)) * this.ballSpeed;
    }
